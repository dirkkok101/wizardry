  ...
  describe('calculateResistance', () => {
    describe('class bonuses', () => {
      ...
      it('returns Ninja combined resistances', () => {
        ...
        expect(
          CharacterResistanceService.calculateResistance(ninja, 'poison').breakdown.classBonus,
        ).toBe(15);
        expect(
          CharacterResistanceService.calculateResistance(ninja, 'paralysis').breakdown.classBonus,
        ).toBe(15);
        expect(
          CharacterResistanceService.calculateResistance(ninja, 'critical').breakdown.classBonus,
        ).toBe(15);
        expect(
          CharacterResistanceService.calculateResistance(ninja, 'stoning').breakdown.classBonus,
        ).toBe(10);
        expect(
          CharacterResistanceService.calculateResistance(ninja, 'breath').breakdown.classBonus,
        ).toBe(20);
        expect(
          CharacterResistanceService.calculateResistance(ninja, 'poisonGasTrap').breakdown
            .classBonus,
        ).toBe(15);
      });
    ...
    describe('level bonus', () => {
      ...
      it('returns +5% for levels 5-9', () => {
        ...
        expect(
          CharacterResistanceService.calculateResistance(char, 'poison').breakdown.levelBonus,
        ).toBe(5);

        const char9 = createTestCharacter({ level: 9, luck: 5 });
        expect(
          CharacterResistanceService.calculateResistance(char9, 'poison').breakdown.levelBonus,
        ).toBe(5);
      });
    ...
    describe('luck bonus', () => {
      it('returns +0% for Luck < 6', () => {
        ...
        expect(
          CharacterResistanceService.calculateResistance(char, 'poison').breakdown.luckBonus,
        ).toBe(0);
      });
      ...
      it('returns +5% for Luck 6-11', () => {
        ...
        expect(
          CharacterResistanceService.calculateResistance(char6, 'poison').breakdown.luckBonus,
        ).toBe(5);

        const char11 = createTestCharacter({ luck: 11, level: 1 });
        expect(
          CharacterResistanceService.calculateResistance(char11, 'poison').breakdown.luckBonus,
        ).toBe(5);
      });
      ...
      it('returns +10% for Luck 12-17', () => {
        ...
        expect(
          CharacterResistanceService.calculateResistance(char12, 'poison').breakdown.luckBonus,
        ).toBe(10);

        const char17 = createTestCharacter({ luck: 17, level: 1 });
        expect(
          CharacterResistanceService.calculateResistance(char17, 'poison').breakdown.luckBonus,
        ).toBe(10);
      });
