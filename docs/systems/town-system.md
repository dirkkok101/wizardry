...
```typescript
function ageCharacter(character: Character, roomType: InnRoomType): Character {
  const agingTable = {
...
- [Characters Reference](../reference/characters.md) - Leveling, stats, resurrection
- [Items Reference](../reference/items.md) - Shop inventory, equipment
- [Combat Formulas](../reference/combat-formulas.md) - Level-up stat formulas

**Systems**:

- [Character Creation](./character-creation-system.md) - Training grounds flow
- [Party System](./party-system.md) - Tavern party management

**Code**:

- `src/app/services/InnService.ts` - Resting mechanics
- `src/app/services/TempleService.ts` - Resurrection, curing
- `src/app/services/ShopService.ts` - Buy/sell equipment
- `src/app/scenes/` - Town scene components
