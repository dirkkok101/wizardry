...
See [Characters Reference](../reference/characters.md) for detailed race analysis.
...
See [Characters Reference](../reference/characters.md) for detailed class data.
...
- [Characters Reference](../reference/characters.md) - Races, classes, stats, leveling
- [Combat Formulas](../reference/combat-formulas.md) - Bonus roll formula

**Systems**:

- [Party System](./party-system.md) - Party formation after creation
- [Town System](./town-system.md) - Training grounds access

**Code**:

- `src/app/services/CharacterService.ts` - Stat validation
- `src/app/scenes/character-creation/` - Creation UI
- `data/races/` - Race JSON files
