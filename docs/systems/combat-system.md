...
- [Combat Formulas](../reference/combat-formulas.md) - All validated combat formulas with pseudocode
- [Monsters Reference](../reference/monsters.md) - Complete monster stats and abilities
- [Treasure Reference](../reference/treasure.md) - Loot generation and distribution
- [Spells Reference](../reference/spells.md) - Combat spell effects

**Systems**:

- [Spell System](./spell-system.md) - Magic in combat
- [Party System](./party-system.md) - Formation effects

**Code**:

- `src/app/services/CombatService.ts` - Combat orchestration
- `src/app/services/InitiativeService.ts` - Turn order
- `data/monsters/` - Monster JSON files
