...
> **📚 SOURCE OF TRUTH**: This document is the authoritative reference for treasure/loot mechanics.
> All treasure-related implementation should use this as the canonical source.
