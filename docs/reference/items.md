...
> **📚 SOURCE OF TRUTH**: This document is the authoritative reference for item mechanics.
> All item-related implementation should use this as the canonical source.
