...
> **📚 SOURCE OF TRUTH**: This document is the authoritative reference for spell mechanics.
> All spell-related implementation should use this as the canonical source.
...
- **Effects** (randomly selected):
  ...
  4. Shield Party (AC = -10) _[bug-free implementation]_
  5. Resurrect and Heal Party _[bug-free implementation]_
