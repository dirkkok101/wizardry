...
> **📚 SOURCE OF TRUTH**: This document is the authoritative reference for combat formulas.
> All combat-related implementation should use this as the canonical source.
...
**Source**: Zimlab - "Priests, Bishops and Lords have the ability to dispel undead monsters back to their plane. They have ((50 + (5 _ Character Level)) - (10 _ Monster Level))% chance to succeed on each monster of a group."
